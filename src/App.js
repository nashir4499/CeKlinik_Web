...
import { clearOrga, getDokters, getKlinik, getOrgaId, getStafs } from './features/orgaKlinik/orgaKlinikSilce';
        ...
        <Switch>
          {!user?(
            <>
              ...
              <Route path="/login" exact={true} component={props=>{
              return(
                <LayoutLogin {...props}>
                  <Login {...props} />
                </LayoutLogin>
